...
class CoordinateSM {
    ...
    static createWithValues(direction, degrees, minutes, seconds) {
        ...
        const coordinate = new CoordinateSM(direction);
...
const coordinate1 = new CoordinateSM("longitude");
const coordinate2 = CoordinateSM.createWithValues("longitude", -50, 20, 10);
...
console.log("2 and 3 middleTwoCoordinate : \n", CoordinateSM.middleTwoCoordinate(coordinate2, coordinate3), "\n");
